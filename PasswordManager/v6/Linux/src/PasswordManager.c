...
int main(){
    ...
    if (!Buffer) {
        printf("Erreur: fichier DATA corrompu\n");
        return 1;
    }
...
String PasswordManager(String DATA,String MDP){
    ...
    while(1){
        ...
        printf_RGB(255,0,255,"[PasswordManager]\n\n");
        ...
        case 3: {
            ...
            system("clear");
            printf_RGB(0,255,0,"Une copie de votre base de donnee de mot de passe a etais faire dans le repetoire \"saves\"!\n\n\n");
            _pause();
...
String PlusInformation(String DATA) {
    ...
    printf_RGB(255,0,255,"[ Plus d'informations ]\n\n");
...
String ConsultationMDP(String DATA){
    ...
    while(1){
        ...
        printf_RGB(255,0,255,"[PasswordManager] -> [Consultez les mots de passe] \n\n");
...
String EditDataBase(String DATA){
    ...
    while(1){
        ...
        printf_RGB(255,0,255,"[PasswordManager] -> [Ajouter/Supprimer/Modifier...]\n\n");
...
String AffichageTableau(String DATA){
    ...
    while(1){
        ...
        printf_RGB(255,0,255,"[PasswordManager] -> [Consultez les mots de passe] -> [Affichage TABLEAU]\n\n");
...
String AffichageListe(String DATA){
    ...
    while(1){
        ...
        printf_RGB(255,0,255,"[PasswordManager] -> [Consultez les mots de passe] -> [Affichage LISTE]\n\n");
...
String AjoutCompte(String DATA){
    ...
    printf_RGB(255,0,255,"[PasswordManager] -> [Ajouter/Supprimer/Modifier...] -> [Ajout]\n\n");
...
String SuppressionCompte(String DATA){
    ...
    printf_RGB(255,0,255,"[PasswordManager] -> [Ajouter/Supprimer/Modifier...] -> [Supprimer]\n\n");
...
String ModificationCompte(String DATA){
    ...
    printf_RGB(255,0,255,"[PasswordManager] -> [Ajouter/Supprimer/Modifier...] -> [Modifiee]\n\n");
...
int SetUp(){
    ...
    if (!fichierCreation) {
        printf("Erreur: impossible de créer DATA.txt\n");
        free(Base);
        free(MDP1);
        free(MDP2);
        return 1;
