        ...
        if(BoolCouleur == 0){
            for(int i=1;i<getNbLigne(DATA);i++){
                if(strcmp(StringBuffer,getLigneXcolonneY(DATA,i,Colonne)) == 0){
                    ...
                    printf_BLUE("%s",getLigneXcolonneY(DATA,i,j));
                    printf(" ");
            ...
            for(int i=1;i<getNbLigne(DATA);i++){
                if(strcmp(StringBuffer,getLigneXcolonneY(DATA,i,Colonne)) == 0){
                    ...
                    printf_GRAY("|  ");
                    // ''
                    printf_YELLOW("%s",getLigneXcolonneY(DATA,i,j));
                    printf(" ");
...
void DisplayOrdonnedListe(String DATA,int colonne){
    ...
    for(int i=1;i<getNbLigne(DATA);i++){
        ...
        if(BoolFound == 0){
            ...
            if(BoolCouleur == 0){
                printf_BLUE(getLigneXcolonneY(DATA,0,colonne));
                printf(" : ");
                printf_BLUE(Buffer);
                printf("\n");
                ...
                printf_YELLOW(getLigneXcolonneY(DATA,0,colonne));
                printf(" : ");
